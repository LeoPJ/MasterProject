...
if __name__ == '__main__':
    ...
    utils.utils.set_logger(os.path.join(args.log_dir, 'main_0412.log'))
    ...
    train_out = preprocess.get_out(processor, './data/mydata/result/train_dataset_0411.json', args, label2id,
                                   'train')
    train_features, train_callback_info = train_out
    train_features, dev_test_features = train_test_split(train_features, train_size=0.8)
    dev_features, test_features = train_test_split(dev_test_features, train_size=0.5)
    ...
    # 测试集
    test_dataset = dataset.MLDataset(test_features)
